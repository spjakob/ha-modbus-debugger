...
try:
    ...
    # Older pymodbus or different structure (3.11 moved framers?)
    # 3.11: pymodbus.framer.rtu.FramerRTU
    try:
...
class ModbusHub:
    ...
    async def connect(self) -> bool:
        ...
        if self._connection_type == CONNECTION_TYPE_TCP:
            framer = ModbusRtuFramer if self._config.get(CONF_RTU_OVER_TCP) else ModbusSocketFramer
